...
def print_daily_projection(overdue_cards, days_needed)
  ...
  puts "  • Novos(10): 10 novos cards do dia anterior que vencem hoje"
  puts "  • Total: Atrasados + Vencem Hoje + Novos(10) = Total de cards para zerar"
  puts "  • Estudados: 100 cards antigos estudados (do Total)"
  puts "  • Novos Hj: 10 novos cards estudados hoje (vão vencer amanhã)"
